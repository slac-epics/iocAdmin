//  =================================================================================
//
//   Abs: Plugin for logging Channel Watcher messages to cout.  Note that cout may
//        be overridden on the command line or overridden with the -l option.
//
//   Name: CWlogmsg_cout.cc
//        
...
#include <iostream.h>          // for cout cout endl flush
...
// =============================================================================
//
//   Abs:  Write to cout given Channel Watcher code and text.
//
...
int CWlogmsg::log(const int code, const char * text) {
    ...
    if (tag) {
      cout << tsStampToText(&current, TIME_FORMAT, message) << " " << tag << " " << text << endl << flush;
      } 
    else {
      cout << tsStampToText(&current, TIME_FORMAT, message) << " " << text << endl << flush;
      };
...
// ================================================================================
//
//   Abs: Write to cout given Channel Watcher code, text, IOC, channel, and 
//        optional time stamp
//
...
//           Mech: reference
//
//   Rem:  Outputs text to cout with EPICS timestamp. If no tstamp is specified, uses
...
// ================================================================================
//
//   Abs:  Write to cout given Channel Watcher code, text, IOC, channel, value,
//         and time stamp
//
//   Name: CWlogmsg::log (code, text, host, device, alias, tstamp)
//
...
//           Mech: value
//
//   Rem:  Outputs text to cout with EPICS timestamp. This routine
...
int CWlogmsg::log (const int code, 
  ...
  cout << tsStampToText((TS_STAMP *)tstamp, TIME_FORMAT, message) 
       << " " 
       << text 
       << endl 
       << flush;
