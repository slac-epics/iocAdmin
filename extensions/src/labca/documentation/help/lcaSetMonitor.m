...
%
%   Use the [2]lcaNewMonitorValue call to check monitor status (local
%   flag) or [3]lcaNewMonitorWait to wait for new data to become available
%   (since last lcaGet or lcaSetMonitor). If new data are available, they
%   are retrieved using the ordinary [4]lcaGet call.
%
...
%   remove all monitors on that channel. Future access to a cleared
%   channel simply reestablishes a connection (but no monitors).
%
%  Parameters
%
%   pvs
...
%          used by default. See [10]here for more information.
%
...
%References
%
%   1. lcaDelay.html#lcadelay
%   2. lcaNewMonitorValue.html#lcanewmonitorvalue
%   3. lcaNewMonitorWait.html#lcanewmonitorwait
%   4. lcaGet.html#lcaget
%   5. lcaNewMonitorValue.html#lcanewmonitorvalue
%   6. lcaNewMonitorWait.html#lcanewmonitorwait
%   7. lcaClear.html#lcaclear
%   8. lcaGet.html#nmaxarg
%   9. lcaGet.html#lcaget
%  10. lcaGet.html#typearg
