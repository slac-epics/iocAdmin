...
%  Description
%
%   Clear / release (disconnect) channels. This is particularly useful
%   with EPICS 3.14 to clean up invalid PVs (e.g., due to typos).
%   Nonexisting PVs are continuously searched for by a CA background task
%   which may result in cluttered IOC consoles and resource consumption.
