...
%
%   The error reported by lasterror corresponds to the first error found
%   in the err_status vector.
%
...
%          return a scalar even if the last operation involved multiple
%          PVs if the error was of general nature (e.g., ``invalid
%          argument''). In this case the scalar is identical to the error
%          reported by scilab's lasterror.
%
%  Examples
%
%try
