...
%  Description
%
%   Set the warning threshold for lcaGet() operations. A warning message
%   is printed when retrieving a PV with a severity bigger or equal to the
...
%   INVALID\_ALARM + 1$ ) or made more sensitive by passing a value of
%   less than 13 ( $=10 + INVALID\_ALARM$ ), the default.
